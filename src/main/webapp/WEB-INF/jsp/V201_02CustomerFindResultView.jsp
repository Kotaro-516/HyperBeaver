...
<div class="result-screen">
	<div class="result-content">
		...
		<h2 class="result-title">得意先検索結果画面</h2>
		...
		<div class="actions">
			<form action="/jsys_sales/jsysFC" method="post">
				<button type="submit" name="buttonId" value="c101">
					得意先検索へ
				</button>
			</form>
		</div>
...
<jsp:include page="Help.jsp">
	...
	<jsp:param name="content" value="検索された得意先の詳細情報が表示されています。<br>「得意先検索へ」をクリックすると検索画面に戻ることができます。" />
</jsp:include>
